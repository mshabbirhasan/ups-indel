...
string diff(string str1, string str2){
    ...
    if(str2== str1.substr(length_difference, str1.length()) && str1.length() > 2 && str2.length() > 2 && str1.substr(0,length_difference+1) != str2){
        return str1.substr(0, length_difference);
    }
